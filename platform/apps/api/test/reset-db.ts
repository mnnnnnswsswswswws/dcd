...
export async function resetDb(prisma: PrismaClient): Promise<void> {
  await prisma.$executeRawUnsafe(
    'TRUNCATE notifications, reports, audit_logs, ledger_entries, payouts, challenge_fundings, votes, evidence_assets, slots, submissions, winner_decisions, challenge_criteria, challenges, users RESTART IDENTITY CASCADE',
  );
}
