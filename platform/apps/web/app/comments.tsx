...
export function SocialRow({
  ...
  return (
    <div className="row" style={{ gap: 14 }}>
      <button className={`sm ghost${liked ? '' : ''}`} onClick={like} style={{ color: liked ? 'var(--danger)' : undefined }}>
      ...
      <button className="sm ghost" onClick={bookmark} style={{ color: saved ? 'var(--violet)' : undefined }}>
        <span style={{ width: 18, height: 18, display: 'inline-flex' }}>
